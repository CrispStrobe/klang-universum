...
const List<Concept> kConcepts = [
  ...
  Concept('aural_memory', GradeBand.g12, ConceptArea.aural,
      'Echo and remember what you hear', ['echo_sequence', 'command_caller'],),
  Concept(
      'sing_what_you_hear',
      GradeBand.g34,
      ConceptArea.aural,
  ...
  Concept('play_percussion', GradeBand.g34, ConceptArea.technique,
      'Read and play a drum rhythm', ['drum_read'],),
  Concept(
      'compose',
      GradeBand.g34,
  ...
  Concept('arrange_loops', GradeBand.g56, ConceptArea.creating,
      'Layer and arrange loops', ['loop_mixer', 'tracker'],),
  Concept(
      'learn_songs',
      GradeBand.g12,
