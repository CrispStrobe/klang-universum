...
- **claude (`feature/score-workshop`, worktree `../mus-workshop`)** · rebuilding
  ...
  agent). shipped dynamics + anchored palette (no bottom sheets). Partitura C1–C5 landed (staff-tap/hover/caret/drag-move/regions/grand-staff) → shipped staff-tap + hover + drag-to-move (C1/C2/C3); next: grand staff (C5) + caret ·
