...
- **@tracker-ui** · wire the 5 shipped engine primitives (full checklist +
  ...
  **Save/Load/Share song** via `tracker_song_codec.dart`
  (`trackerSongToJsonString`/`FromJsonString` — lossless, the JSON string is the
  share token).
